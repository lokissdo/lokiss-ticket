...
class ProviderRegisteringRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'email' => [
                ...
                'max:255',
                function ($attribute, $value, $fail) {
                    $role = DB::table('users')->where('email',$value)->first()->role;
                    if($role!=UserRoleEnum::PASSENGER) $fail('Chủ của nhà xe phải tạo tài khoản chưa phân quyền.');
                },
            ],
            'phone_number' => [
                'bail',
